    ...
    <section class="section-four" id="testimonials">
        <div class="carousel-holder">
            ...
            <div class="wow fadeIn">
                ...
                <!--<div class="view-all">
                    <a href="testimonial.php" class="blue-small-btn wow fadeIn">VIEW ALL</a>
                </div> -->
            </div>
        </div>
    </section>
    <!--<section class="section-sixth border-bottom">
        <div class="container">
            <div class="content-holder">
                <h2 class="head-text wow fadeInDown">A bit about Us</h2>
                <h5>We can write a bit here
                </h5>
                <div class="row scholfin-team-holder">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="scholfin-team wow fadeIn">
                            <div class="image-holder">
                                <img class="img-responsive" src="images/team/3.jpg" alt="team" />
                            </div>
                            <div class="details-holder">
                                <h4>Mark zukerkberg</h4>
                                <h5>Founder</h5>
                                <ul class="social-icons">
                                    <li><a href="#"><span class="sprite fb"></span></a></li>
                                    <li><a href="#"><span class="sprite tweet"></span></a></li>
                                    <li><a href="#"><span class="sprite linkedin"></span></a></li>
                                </ul>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="scholfin-team wow fadeIn" data-wow-delay=".4s">
                            <div class="image-holder">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-md-offset-0 col-sm-offset-3 col-xs-12">
                        <div class="scholfin-team wow fadeIn" data-wow-delay=".8s">
                            <div class="image-holder">
                ...
                <div class="view-all">
                    <a href="about.php" class="blue-small-btn wow fadeIn">VIEW TEAM</a>
                </div>
            </div>
        </div>
    </section>-->
